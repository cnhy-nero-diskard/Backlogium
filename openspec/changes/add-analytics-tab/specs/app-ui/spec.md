...
quest-met days within the window. The most-played-games list SHALL rank games by tracked minutes
within the window, distinct from the Library's lifetime playtime ordering, and SHALL show at most
five entries.
