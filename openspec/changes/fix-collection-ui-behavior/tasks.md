...
- [ ] 1.1 Bug #1 spike: open the collection management form, focus the Add-games search so the keyboard rises, and
...
- [ ] 1.2 Bug #3 spike: add temporary logging to `onDragEnd` and `onDragCancel` in `CollectionsSection`
