...
- [ ] 2.1 Add a bounded, account-fenced multi-page routine read through the existing serialized repository and ingest callback; persist owned-game interval evidence before each page advances the shared cursor; verify a paginated test consumes through the terminal page without another reader stealing its cursor.
