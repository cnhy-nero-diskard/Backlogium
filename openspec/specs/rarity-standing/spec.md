...
Defines the mathematically provable rarity standing and average-owner achievement count derived
from Steam's published global achievement unlock rates.
...
The derivation SHALL remain valid when some achievements have unknown unlock rates, by drawing only
on achievements whose rates are known while still counting every achievement toward the player's
missing count.
