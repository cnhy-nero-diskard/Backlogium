...
Defines the app's wishlist capability: retrieving the player's Steam wishlist, observing and
recording game prices over time, presenting wishlisted games in the Library, and surviving
wishlist or price unavailability without affecting the rest of the app.

## Requirements

### Requirement: The wishlist is retrieved, and ordered by what is worth deciding on now### Requirement: The wishlist is retrieved, and ordered by what is worth deciding on now
